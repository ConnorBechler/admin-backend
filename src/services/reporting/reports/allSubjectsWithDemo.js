...
const reportOutput = async (app, params) => {
  ...
  let rawq = `select
      subjects.shortcode as 'subjectId',
        ...
        subjects.createdAt,
        subjects.metadata->>'$.consent' as 'consent',
        ...
        subjects.metadata->>'$.educationLevel' as 'educationLevel',
        subjects.metadata->>'$.otherInfo' as 'otherInfo',
        subjects.metadata->>'$.participant_category' as 'category',
