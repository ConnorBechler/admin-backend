module.exports = function(app) {
  ...
  app.on('login', (authResult, { connection }) => {
    ...
    if(connection) {
      ...
      if(user.roles.includes('ra') || user.roles.includes('ga') || user.roles.includes('user')) { 
        app.channel('assistants').join(connection); 
      }
      ...
      app.channel(`private/${user.id}`).join(connection);
    }
  });
